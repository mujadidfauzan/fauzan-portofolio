...
const About = () => {
  return (
    <div id="about" className="min-h-screen pt-24 pb-10 px-4">
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-16 text-light1">About Me</h1>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
        <div data-aos="slide-right" className="relative group flex justify-center items-center">
        ...
        <div className="space-y-8 text-light1">
          <div className="space-y-4">
            ...
            <div className="space-y-6">
              <p data-aos="fade-up" data-aos-delay="300" className="text-lg leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div data-aos="fade-up" data-aos-delay="500" className="p-4 bg-dark1/40 rounded-xl border border-light1/10">
